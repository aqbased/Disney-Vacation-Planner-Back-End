...
1. Rename the directory from DisneyVacationPlanner -> your-app-name.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Move into the new project and `git init`.
1. Replace all instances of `'DisneyVacationPlanner'` with your app name.
...
# Disney-Vacation-Planner-Back-End
